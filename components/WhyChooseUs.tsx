  ...
  return (
    <section className='px-5 md:px-10 lg:px-40 py-8 bg-gray-50'>
      ...
      <div className='grid md:grid-cols-3 gap-6'>
        {reasons.map((reason) => (
          <div key={reason.title} className='bg-white rounded-xl p-5 shadow-card border-l-4 border-brand-teal'>
            <h3 className='font-bold text-brand-teal text-lg mb-2'>{reason.title}</h3>
