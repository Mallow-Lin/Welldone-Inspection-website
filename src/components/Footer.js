        ...
        <div className='flex flex-col justify-center bg-[#1b6666] lg:mt-5'>
            <div className='flex flex-col md:flex-row justify-center items-center md:items-start md:h-[260px] py-10 md:py-14 px-4 gap-8 md:gap-0'>
                <div className='flex flex-col w-full md:w-[320px] space-y-2 md:mx-10 lg:mx-20 items-center md:items-start text-center md:text-left'>
                    <img src={mottoLogo} alt='WellDone Inspection logo' className='w-[200px]' />
                    <p className='text-[#ecb403] font-serif text-[10px] md:text-[12px] lg:text-[15px]'>{siteConfig.mwbe}</p>
                </div>
                <div className='hidden md:block border-[#3f3f3f] border-l-[1px] border-solid h-full' />
                <div className='flex flex-col w-full md:w-[250px] justify-center items-center space-y-2 text-[#ecb403] md:mx-10 lg:mx-20'>
                ...
                <div className='hidden md:block border-[#3f3f3f] border-l-[1px] border-solid h-full' />
                <div className='flex flex-col items-center md:items-start space-y-4 text-[#ecb403] md:mx-10 lg:mx-20'>
